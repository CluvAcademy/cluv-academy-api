 ...
 */
@RestController
@RequestMapping("private/CalificacionTutor")
public class CalificacionTutorRest {

    @Autowired
    private CalificacionTutorService service;
    ...
    public ResponseEntity<?> create(@RequestBody CalificacionTutorDto obj) throws Exception {
        CalificacionTutorDto dto = service.create(obj);
        ResponseGenerico<CalificacionTutorDto> response = new ResponseGenerico<>();
        try {
    ...
    public ResponseEntity<?> listar() {
        ResponseGenerico<CalificacionTutorDto> response = new ResponseGenerico<>();
        try {
            List<CalificacionTutorDto> lista = service.findAll();
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
    ...
    public ResponseEntity<?> findById(@PathVariable int id) {
        ResponseGenerico<CalificacionTutorDto> response = new ResponseGenerico<>();
        try {
            CalificacionTutorDto dto = service.findById((long) id);
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
            response.setObjeto(dto);
            response.setMensaje(EnumMessages.REGISTRO_EXISTENTE.name());
