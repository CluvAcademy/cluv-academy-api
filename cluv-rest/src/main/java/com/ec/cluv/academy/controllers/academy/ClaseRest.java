...
public class ClaseRest {
    ...
    public ResponseEntity<?> create(@RequestBody ClaseDto obj) throws Exception {
        ClaseDto dto = service.create(obj);
        ResponseGenerico<ClaseDto> response = new ResponseGenerico<>();
        try {
    ...
    public ResponseEntity<?> listar() {
        ResponseGenerico<ClaseDto> response = new ResponseGenerico<>();
        try {
            List<ClaseDto> lista = service.findAll();
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
    ...
    @GetMapping(value = "listarAllClasesLanding")
    public ResponseEntity<?> listarAllClasesLanding() {
        ResponseGenerico<ClaseLandingDto> response = new ResponseGenerico<>();
        try {
            List<ClaseLandingDto> lista = service.getAllClasesLanding();
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
            response.setListado(lista);
            response.setTotalRegistros((long) lista.size());
    ...
    public ResponseEntity<?> findById(@PathVariable int id) {
        ResponseGenerico<ClaseDto> response = new ResponseGenerico<>();
        try {
            ClaseDto dto = service.findById((long) id);
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
            response.setObjeto(dto);
            response.setMensaje(EnumMessages.REGISTRO_EXISTENTE.name());
