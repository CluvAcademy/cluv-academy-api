 ...
 */
@RestController
@RequestMapping("private/InfoDestrezas")
public class InfoDestrezasRest {

    @Autowired
    private InfoDestrezasService service;
    ...
    public ResponseEntity<?> create(@RequestBody InfoDestrezasDto obj) throws Exception {
        InfoDestrezasDto dto = service.create(obj);
        ResponseGenerico<InfoDestrezasDto> response = new ResponseGenerico<>();
        try {
    ...
    public ResponseEntity<?> listar() {
        ResponseGenerico<InfoDestrezasDto> response = new ResponseGenerico<>();
        try {
            List<InfoDestrezasDto> lista = service.findAll();
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
    ...
    public ResponseEntity<?> findById(@PathVariable int id) {
        ResponseGenerico<InfoDestrezasDto> response = new ResponseGenerico<>();
        try {
            InfoDestrezasDto dto = service.findById((long) id);
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
            response.setObjeto(dto);
            response.setMensaje(EnumMessages.REGISTRO_EXISTENTE.name());
