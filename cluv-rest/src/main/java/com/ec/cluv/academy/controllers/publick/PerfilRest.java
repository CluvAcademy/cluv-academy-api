...
public class PerfilRest {
    ...
    /**
     * REST para guardar o actualizar PerfilDto
     *
     * @return guardar
     */
    @PostMapping(value = "guardarPerfil")
    public ResponseEntity<?> create(@RequestBody PerfilDto obj) throws Exception {
        PerfilDto dto = service.create(obj);
        ResponseGenerico<PerfilDto> response = new ResponseGenerico<>();
        try {
     ...
     */
    @GetMapping(value = "listaPerfil")
    public ResponseEntity<?> listar() {
        ResponseGenerico<PerfilDto> response = new ResponseGenerico<>();
        try {
            List<PerfilDto> lista = service.findAll();
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
    ...
    @GetMapping(value = "buscarPorIdPerfil/{id}")
