 ...
 */
@RestController
@RequestMapping("private/HorasHorario")
public class HorasHorarioRest {

    @Autowired
    private HorasHorarioService service;
    ...
    public ResponseEntity<?> create(@RequestBody HorasHorarioDto obj) throws Exception {
        HorasHorarioDto dto = service.create(obj);
        ResponseGenerico<HorasHorarioDto> response = new ResponseGenerico<>();
        try {
    ...
    public ResponseEntity<?> listar() {
        ResponseGenerico<HorasHorarioDto> response = new ResponseGenerico<>();
        try {
            List<HorasHorarioDto> lista = service.findAll();
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
    ...
    public ResponseEntity<?> findById(@PathVariable int id) {
        ResponseGenerico<HorasHorarioDto> response = new ResponseGenerico<>();
        try {
            HorasHorarioDto dto = service.findById((long) id);
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
            response.setObjeto(dto);
            response.setMensaje(EnumMessages.REGISTRO_EXISTENTE.name());
